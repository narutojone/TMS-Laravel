            ...
            <div class="wrapper wrapper-content">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form  id="form" class="form-horizontal" role="form" method="POST" action="{{ action('OverdueReasonController@store') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ ($errors->has('complete_task') || ($errors->has('completed_user_id')) ) ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <input type="checkbox" class="js-switch" value="1" id="complete_task" name="complete_task" {{ (old('complete_task')) ? ' checked' : '' }}>
                                ...
                                <label class="col-sm-2 control-label completed-users-item" for="complete_task" style="{{!old('complete_task') ? 'display:none' : ''}}">Completed user</label>
                                <div class="col-sm-3 completed-users-item" style="{{!old('complete_task') ? 'display:none' : ''}}">
                                    <select class="form-control chosen-select chosen-select-hidden" name="completed_user_id" id="completed_user_id">
                       `                 <option value=""></option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ (old('completed_user_id') == $user->id) ? 'selected' : '' }} >{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('required') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" class="js-switch" value="1" id="required" name="required">
                            ...
                            <div class="form-group{{ $errors->has('hex') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="hex", id="hex" class="form-control colorpicker-element" value="#ED5565" />
                            ...
                            <div class="form-group{{ $errors->has('default') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" class="js-switch" value="1" id="default" name="default">
                            ...
                            <div class="form-group{{ $errors->has('is_visible_in_report') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" class="js-switch" value="1" id="is_visible_in_report" name="is_visible_in_report">
                            ...
                            <div class="form-group{{ $errors->has('threshold_value') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0" class="form-control" name="threshold_value" id="threshold_value" value="0">
