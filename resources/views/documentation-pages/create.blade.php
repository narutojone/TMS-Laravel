...
@section('title', 'Create documentation page ')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ action('DocumentationPagesController@index') }}">Documentation</a>
                </li>
                <li class="active">
            ...
            <div class="wrapper wrapper-content">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method="POST" action="{{ action('DocumentationPagesController@store') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('order') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="order" id="order" value="{{ old('order') }}" min="0" oninput="validity.valid||(value='');" required>
                                    @if ($errors->has('order'))
                                        <span class="help-block m-b-none">
                                ...
                                <div class="col-sm-10">
                                    <select name="parent_page_id" id="parent_page_id" class="form-control chosen-select">
                                        ...
                                        @foreach($parentPageDropdown as $page_id => $page_name)
                                            <option value="{{ $page_id }}" {{ old('parent_page_id') == $page_id ? 'selected' : '' }}>{{ $page_name }}</option>
                                        @endforeach
                                    </select>
