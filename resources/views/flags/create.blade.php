            ...
            <div class="wrapper wrapper-content">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('settings.flags.store') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" id="days" name="days" value="{{ old('days') }}">
                            ...
                            <div class="form-group{{ $errors->has('client_specific') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" class="js-switch" id="client_specific" value="1" name="client_specific" />
                            ...
                            <div class="form-group{{ $errors->has('client_removal') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" class="js-switch" id="client_removal" value="1" name="client_removal" />
                            ...
                            <div class="form-group{{ $errors->has('sms') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="sms" id="sms" class="form-control">{{old('sms','')}}</textarea>
                                    <span class="help-block m-b-none">Leave this empty if no SMS needs to be sent to flagged user!</span>
                            ...
                            <div class="form-group{{ $errors->has('hex') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="hex", id="hex" class="form-control colorpicker-element" value="{{ old('hex', '#ED5565') }}" />
