...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('settings.information.show', $information) }}">{{ $information->title }}</a>
            </li>
            <li class="active">
                <strong>Edit</strong>
            </li>
        ...
        <div class="wrapper wrapper-content">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form" class="form-horizontal" role="form" method="POST" action="{{ route('settings.information.update', $information) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $information->title) }}" required autofocus>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control chosen-select" name="visibility[]" id="visibility" multiple>
                                    @foreach ($visibilityOptionsArray as $visibilityOption)
                                        <option value="{{ $visibilityOption }}"{{ in_array($visibilityOption, old('visibility', $information->visibility)) ? ' selected' : '' }}>{{ $visibilityOption }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                @include('quill.edit', [
                                    'form' => 'form#form',
                                    'name' => 'description',
                                    'delta' => old('description', $information->description)
                                ])
