...
return $settings = array(
    ...
    'idp' => array(
         ...
         */
        'certFingerprint' => env('SAML2_IDP_cFi',''),
    ),
    ...
    'contactPerson' => array(
        'technical' => array(
            'givenName' => 'Robin Nydahl',
            'emailAddress' => 'robin.nydahl@synega.com'
        ),
        'support' => array(
            'givenName' => 'Support',
            'emailAddress' => 'support@acgr.no'
        ),
    ),
    ...
    'organization' => array(
        'en-US' => array(
            'name' => 'Accounting Group AS',
            'displayname' => 'Accounting Group AS',
            'url' => 'https://acgr.no'
        ),
    ),
