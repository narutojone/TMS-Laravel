...
return [
     ...
     */
    'api_key' => env('DEV_HARVEST_API_KEY', ''),

    /*
     * Account Id of the company you want to integrate the api for.
     */
    'account_id' => env('DEV_HARVEST_ACCOUNT_ID', ''),

    /*
     * Api Key used for authenticating at Harvest API in [for artisan console command]
     */
    'main_api_key' => env('MAIN_HARVEST_API_KEY', ''),

    /*
     * Account Id of the company you want to integrate the api for. [for artisan console command]
     */
    'main_account_id' => env('MAIN_HARVEST_ACCOUNT_ID', ''),
