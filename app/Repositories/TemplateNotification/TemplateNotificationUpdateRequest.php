...
/**
 * Validation rules that are used when we try to update an TemplateNotification entity via api request
 */
class TemplateNotificationUpdateRequest extends Request {
