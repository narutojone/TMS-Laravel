<?php namespace App\Repositories\ReviewSettingTemplate;
 ...
 */
class ReviewSettingTemplateCreateValidator extends LaravelValidator implements ValidableInterface {
     ...
     */
    protected $rules = [
        'review_setting_id' =>  'required|exists:review_settings,id',
