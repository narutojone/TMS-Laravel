 ...
 */
class DocumentationPageUpdateValidator extends LaravelValidator implements ValidableInterface
{
    ...
    protected $rules = [
        ...
        'parent_page_id' => 'sometimes|nullable|integer|exists:documentation_pages,id',
