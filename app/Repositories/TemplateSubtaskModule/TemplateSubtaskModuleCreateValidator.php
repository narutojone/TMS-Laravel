 ...
 */
class TemplateSubtaskModuleCreateValidator extends LaravelValidator implements ValidableInterface {
     ...
     */
    protected $rules = [
        'subtask_id'        => 'required|exists:template_subtasks,id',
        'subtask_module_id' => 'required|exists:subtask_module_templates,id',
