<?php namespace App\Repositories\Review;
 ...
 */
class ReviewCreateValidator extends LaravelValidator implements ValidableInterface {
    ...
    protected $rules = [
        ...
        'reviewer_task_id'  => 'required|exists:tasks,id',
